...
function TaskStructureRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of TaskStructureComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function yourGoalRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of yourGoalComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function keyInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of keyInstructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function learningLoopLoopBegin(learningLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLearningLoop of learningLoop) {
...
function practiceDecisionLoopLoopBegin(practiceDecisionLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPracticeDecisionLoop of practiceDecisionLoop) {
...
function decisionLoopLoopBegin(decisionLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisDecisionLoop of decisionLoop) {
...
function crosshair5RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshair5Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function actualPoints1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of actualPoints1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crosshair3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshair3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function taskStartSoonRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of taskStartSoonComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function scannerSyncRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of scannerSyncComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function scannerWaitRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of scannerWaitComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crosshair1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshair1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function actualPointsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of actualPointsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crosshair2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshair2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function blockTransitionRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of blockTransitionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function taskStartSoonBlock2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of taskStartSoonBlock2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function scannerSyncBlock2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of scannerSyncBlock2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crosshairBlock2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshairBlock2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function scannerWaitBlock2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of scannerWaitBlock2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crosshair2Block2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshair2Block2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function decisionPhaseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of decisionPhaseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function decisionInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of decisionInstructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function whichFruitRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of whichFruitComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practiceIntro2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practiceIntro2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practiceDecisionSimulus1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practiceDecisionSimulus1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crosshairPracticeDecision1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshairPracticeDecision1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practiceDecisionSimulus2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practiceDecisionSimulus2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crosshairPracticeDecision2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshairPracticeDecision2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practiceDecisionMakingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practiceDecisionMakingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crosshairPracticeDecision3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshairPracticeDecision3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function taskStartSoonBlock3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of taskStartSoonBlock3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function scannerSyncBlock3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of scannerSyncBlock3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crosshair3Block3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of crosshair3Block3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function scannerWaitBlock3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of scannerWaitBlock3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function startTaskBlock3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of startTaskBlock3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function decisionStimulus1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of decisionStimulus1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function decisionITI1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of decisionITI1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function decisionStimulus2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of decisionStimulus2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function decisionITI2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of decisionITI2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function decisionMakingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of decisionMakingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function decisionTimeoutRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of decisionTimeoutComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function decisionITI3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of decisionITI3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
